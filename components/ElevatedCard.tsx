...
const styles = StyleSheet.create({
    ...
    card: {
        ...
        height: 100,
        margin: 3,
        borderRadius: 50,  // Add borderRadius here for the card
    },
    cardElevated: {
        ...
        shadowOpacity: 0.4,
        shadowRadius: 3,
        borderRadius: 50,  // Add borderRadius here for the elevated card
    },
    cardContent: {
        position: 'relative',
        width: 100,
        ...
        alignItems: 'center',
        justifyContent: 'center',
        borderRadius: 50,  // Add borderRadius here for the content
    },
    cardImage: {
        height: 117,
        width: 100,
        ...
        top: 0,
        left: 0,
        borderRadius: 50,  // Add borderRadius here for the image
    },
    cardText: {
        color: '#FFFFFF',
        fontWeight: 'bold',
